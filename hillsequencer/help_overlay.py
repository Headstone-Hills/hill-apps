"""HillSequencer — scrollable controls cheat-sheet overlay (Select+B)."""
...
# Flat list: ("head", text) or ("row", key, desc).
LINES = [
    ("head", "TRANSPORT"),
